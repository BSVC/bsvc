...
class cpu32 : public BasicCPU {
  ...
  private:
    ...
    typedef int (cpu32::*ExecutionPointer)(int, string&, int);
    ...
    int ExecuteDIVL(int opcode, string& description, int trace);
    ...
    int ExecuteMOVES(int opcode, string& description, int trace);
    // MOVEC: move from and to special registers VBR,SFC, DFC
    int ExecuteMOVEC(int opcode, string& description, int trace);
    ...
    int ExecuteMULL(int opcode, string& description, int trace);
    ...
    int ExecuteRTD(int opcode, string& description, int trace);
